...
def create_product(
    db: Session, name: str, description: str, price: float, new_price: float, image_files: List[str]
):
    # Create product instance
    product = Product(name=name, description=description, price=price, new_price=new_price)
    db.add(product)
    db.commit()
    db.refresh(product)
